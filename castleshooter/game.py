...
class Game:
    ...
    def maybe_die(self, client_player: Player, verb: str, killer_id: int) -> None:
        if client_player.hp <= 0:
            ...
            message = f'Player {get_player_number_from_client_id(killer_id, client_id=self.client.id if not self.client.ai else None, game_name=self.client.game_name)} {verb} you!'
